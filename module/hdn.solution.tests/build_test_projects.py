...
solution_file = "D:/_DEV/_HEDRON/module/hdn.solution.tests/tests.sln"
folder_name = "test"
...
for project in projects_to_build:
    ...
    executable_path = Path(os.path.join("D:/_DEV/_HEDRON/module/hdn.solution.tests/", f"{project_folder_path}/out/bin/win64-release/{project_name}.exe")).resolve(strict=False)
...
write_project_executable("D:/_DEV/_HEDRON/module/hdn.solution.tests/test_executable_list.txt", project_executable_list)