...
#ifndef FLATBUFFERS_GENERATED_ZONEALIAS_DM_H_
#define FLATBUFFERS_GENERATED_ZONEALIAS_DM_H_
...
namespace dm
{
			...
			const char *zone_name = nullptr)
	{
		...
		return dm::CreateXZoneAliasAsset(
				_fbb,
				id,
				name__,
				zone_name__);
	...
	inline const dm::XZoneAliasAsset *GetXZoneAliasAsset(const void *buf)
	{
		return ::flatbuffers::GetRoot<dm::XZoneAliasAsset>(buf);
	}

	inline const dm::XZoneAliasAsset *GetSizePrefixedXZoneAliasAsset(const void *buf)
	{
		return ::flatbuffers::GetSizePrefixedRoot<dm::XZoneAliasAsset>(buf);
	}

	inline bool VerifyXZoneAliasAssetBuffer(
			::flatbuffers::Verifier &verifier)
	{
		return verifier.VerifyBuffer<dm::XZoneAliasAsset>(nullptr);
	}

	inline bool VerifySizePrefixedXZoneAliasAssetBuffer(
			::flatbuffers::Verifier &verifier)
	{
		return verifier.VerifySizePrefixedBuffer<dm::XZoneAliasAsset>(nullptr);
	}

	inline void FinishXZoneAliasAssetBuffer(
			::flatbuffers::FlatBufferBuilder &fbb,
			::flatbuffers::Offset<dm::XZoneAliasAsset> root)
	{
		fbb.Finish(root);
	}
...
#endif // FLATBUFFERS_GENERATED_ZONEALIAS_DM_H_
