...
#ifndef FLATBUFFERS_GENERATED_FEATURE_DM_H_
#define FLATBUFFERS_GENERATED_FEATURE_DM_H_
...
namespace dm
{
	...
	struct CFeatureZoneEntry FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
	{
		...
		dm::CAssetType asset_type() const
		{
			return static_cast<dm::CAssetType>(GetField<uint32_t>(VT_ASSET_TYPE, 0));
		}
	...
	struct CFeatureZoneEntryBuilder
	{
		...
		void add_asset_type(dm::CAssetType asset_type)
		{
	...
	inline ::flatbuffers::Offset<CFeatureZoneEntry> CreateCFeatureZoneEntry(
			...
			dm::CAssetType asset_type = dm::CAssetType_buildconfig)
	{
			...
			dm::CAssetType asset_type = dm::CAssetType_buildconfig)
	{
		...
		return dm::CreateCFeatureZoneEntry(
				_fbb,
				asset_name__,
				asset_type);
	}
	...
	struct CFeatureZone FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
	{
		...
		const ::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZoneEntry>> *asset_entries() const
		{
			return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZoneEntry>> *>(VT_ASSET_ENTRIES);
		}
		bool Verify(::flatbuffers::Verifier &verifier) const
		{
			return VerifyTableStart(verifier) &&
	...
	struct CFeatureZoneBuilder
	{
		...
		void add_asset_entries(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZoneEntry>>> asset_entries)
		{
	...
	inline ::flatbuffers::Offset<CFeatureZone> CreateCFeatureZone(
			...
			::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZoneEntry>>> asset_entries = 0)
	{
	...
	inline ::flatbuffers::Offset<CFeatureZone> CreateCFeatureZoneDirect(
			...
			const std::vector<::flatbuffers::Offset<dm::CFeatureZoneEntry>> *asset_entries = nullptr)
	{
		auto alias_asset__ = alias_asset ? _fbb.CreateString(alias_asset) : 0;
		auto asset_entries__ = asset_entries ? _fbb.CreateVector<::flatbuffers::Offset<dm::CFeatureZoneEntry>>(*asset_entries) : 0;
		return dm::CreateCFeatureZone(
				_fbb,
				alias_asset__,
				asset_entries__);
	}
	...
	struct XFeatureAsset FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table
	{
		...
		const ::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZone>> *zones() const
		{
			return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZone>> *>(VT_ZONES);
		}
		bool Verify(::flatbuffers::Verifier &verifier) const
		{
			return VerifyTableStart(verifier) &&
	...
	struct XFeatureAssetBuilder
	{
		...
		void add_zones(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZone>>> zones)
		{
	...
	inline ::flatbuffers::Offset<XFeatureAsset> CreateXFeatureAsset(
			...
			::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<dm::CFeatureZone>>> zones = 0)
	{
	...
	inline ::flatbuffers::Offset<XFeatureAsset> CreateXFeatureAssetDirect(
			...
			const std::vector<::flatbuffers::Offset<dm::CFeatureZone>> *zones = nullptr)
	{
		auto name__ = name ? _fbb.CreateString(name) : 0;
		auto feature_assets__ = feature_assets ? _fbb.CreateVector<::flatbuffers::Offset<::flatbuffers::String>>(*feature_assets) : 0;
		auto zones__ = zones ? _fbb.CreateVector<::flatbuffers::Offset<dm::CFeatureZone>>(*zones) : 0;
		return dm::CreateXFeatureAsset(
				_fbb,
				id,
				name__,
				feature_assets__,
	...
	inline const dm::XFeatureAsset *GetXFeatureAsset(const void *buf)
	{
		return ::flatbuffers::GetRoot<dm::XFeatureAsset>(buf);
	}

	inline const dm::XFeatureAsset *GetSizePrefixedXFeatureAsset(const void *buf)
	{
		return ::flatbuffers::GetSizePrefixedRoot<dm::XFeatureAsset>(buf);
	}

	inline bool VerifyXFeatureAssetBuffer(
			::flatbuffers::Verifier &verifier)
	{
		return verifier.VerifyBuffer<dm::XFeatureAsset>(nullptr);
	}

	inline bool VerifySizePrefixedXFeatureAssetBuffer(
			::flatbuffers::Verifier &verifier)
	{
		return verifier.VerifySizePrefixedBuffer<dm::XFeatureAsset>(nullptr);
	}

	inline void FinishXFeatureAssetBuffer(
			::flatbuffers::FlatBufferBuilder &fbb,
			::flatbuffers::Offset<dm::XFeatureAsset> root)
	{
		fbb.Finish(root);
	}
...
#endif // FLATBUFFERS_GENERATED_FEATURE_DM_H_
