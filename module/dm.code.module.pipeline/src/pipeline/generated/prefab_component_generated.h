...
template<> struct CComponentUnionTraits<dm::CTransformComponent> {
  static const CComponentUnion enum_value = CComponentUnion_CTransformComponent;
};

template<> struct CComponentUnionTraits<dm::CModelComponent> {
  static const CComponentUnion enum_value = CComponentUnion_CModelComponent;
};

template<> struct CComponentUnionTraits<dm::CLightComponent> {
  static const CComponentUnion enum_value = CComponentUnion_CLightComponent;
};

template<> struct CComponentUnionTraits<dm::CScriptComponent> {
...
template<> inline const dm::CTransformComponent *CComponent::data_as<dm::CTransformComponent>() const {
  return data_as_CTransformComponent();
}

template<> inline const dm::CModelComponent *CComponent::data_as<dm::CModelComponent>() const {
  return data_as_CModelComponent();
}

template<> inline const dm::CLightComponent *CComponent::data_as<dm::CLightComponent>() const {
  return data_as_CLightComponent();
}

template<> inline const dm::CScriptComponent *CComponent::data_as<dm::CScriptComponent>() const {
