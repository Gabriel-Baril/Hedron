...
#define EVENT_CLASS_CATEGORY(category) \
	virtual utype<EventCategory> get_category_flags() const override { return underlying(category); }
...
namespace dm
{
	...
	{
		NONE = 0,
		APPLICATION = DM_BIT(0),
		INPUT = DM_BIT(1),
		KEYBOARD = DM_BIT(2),
		MOUSE = DM_BIT(3),
		MOUSE_BUTTON = DM_BIT(4)
	};
	DM_DEFINE_ENUM_CLASS_BITWISE_OPERATIONS(EventCategory)
