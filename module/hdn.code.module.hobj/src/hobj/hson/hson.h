...
namespace hdn
{
	...
	{
		MINIMAL = 0,
		SERIALIZE_INTERMEDIATE_FIELD = HDN_BIT(0),
		SERIALIZE_FIELD_HIERARCHY = HDN_BIT(1),
		SERIALIZE_FIELD_NAME = HDN_BIT(2),
		SERIALIZE_FIELD_TYPE = HDN_BIT(3),
		SERIALIZE_FIELD_PAYLOAD_SIZE = HDN_BIT(4),
	...
	HDN_DEFINE_ENUM_CLASS_BITWISE_OPERATIONS(HsonFlags);
