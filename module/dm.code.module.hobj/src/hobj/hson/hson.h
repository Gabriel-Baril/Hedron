...
namespace dm
{
	...
	{
		MINIMAL = 0,
		SERIALIZE_INTERMEDIATE_FIELD = DM_BIT(0),
		SERIALIZE_FIELD_HIERARCHY = DM_BIT(1),
		SERIALIZE_FIELD_NAME = DM_BIT(2),
		SERIALIZE_FIELD_TYPE = DM_BIT(3),
		SERIALIZE_FIELD_PAYLOAD_SIZE = DM_BIT(4),
	...
	DM_DEFINE_ENUM_CLASS_BITWISE_OPERATIONS(HsonFlags);
